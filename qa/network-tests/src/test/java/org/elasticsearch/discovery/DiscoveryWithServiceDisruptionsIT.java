...
public class DiscoveryWithServiceDisruptionsIT extends ESNettyIntegTestCase {
    ...
    protected Settings nodeSettings(int nodeOrdinal) {
        return Settings.builder().put(super.nodeSettings(nodeOrdinal)).put(discoveryConfig.nodeSettings(nodeOrdinal)).build();
    }
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return pluginList(MockTransportService.TestPlugin.class, NettyPlugin.class);
    }
    ...
    public void testSearchWithRelocationAndSlowClusterStateProcessing() throws Exception {
        ...
        transportServiceNode2.addTracer(new MockTransportService.ReclocationStartEndTracer(logger, beginRelocationLatch,
                endRelocationLatch));
