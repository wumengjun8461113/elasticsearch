...
@SuppressWarnings("*")
public class DedicatedClusterSnapshotRestoreTests extends AbstractSnapshotIntegTestCase {
    @Override
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return pluginList(MockRepository.Plugin.class, NettyPlugin.class);
    }
