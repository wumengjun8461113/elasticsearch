...
public class DeflateXContentTests extends ESTestCase {
    ...
    public void testDifferentCompressedRepresentation() throws Exception {
        ...
        StreamOutput out = CompressorFactory.getCompressor().streamOutput(bout);
        out.writeBytes(b);
        out.flush();
        out.writeBytes(b);
        out.close();
        ...
        out =  CompressorFactory.getCompressor().streamOutput(bout);
        out.writeBytes(b);
        out.writeBytes(b);
        out.close();
